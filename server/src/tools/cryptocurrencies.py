...
def currency_exchange_rate(
    ...
    Args:
        ...
        datatype: By default, datatype=json. Strings json and csv are accepted with the following specifications: json returns the exchange rate in JSON format; csv returns the data as a CSV (comma separated value) file.
    ...
    return _make_api_request("CURRENCY_EXCHANGE_RATE", params, datatype)
...
def crypto_intraday(
    ...
    return _make_api_request("CRYPTO_INTRADAY", params, datatype)
...
def digital_currency_daily(
    ...
    Args:
        ...
        datatype: By default, datatype=json. Strings json and csv are accepted with the following specifications: json returns the daily time series in JSON format; csv returns the data as a CSV (comma separated value) file.
    ...
    return _make_api_request("DIGITAL_CURRENCY_DAILY", params, datatype)
...
def digital_currency_weekly(
    ...
    Args:
        symbol: The digital/crypto currency of your choice. It can be any of the currencies in the digital currency list. For example: symbol=BTC.
        market: The exchange market of your choice. It can be any of the market in the market list. For example: market=EUR.
        datatype: By default, datatype=json. Strings json and csv are accepted with the following specifications: json returns the weekly time series in JSON format; csv returns the data as a CSV (comma separated value) file.
    ...
    return _make_api_request("DIGITAL_CURRENCY_WEEKLY", params, datatype)
...
def digital_currency_monthly(
    ...
    Args:
        symbol: The digital/crypto currency of your choice. It can be any of the currencies in the digital currency list. For example: symbol=BTC.
        market: The exchange market of your choice. It can be any of the market in the market list. For example: market=EUR.
        datatype: By default, datatype=json. Strings json and csv are accepted with the following specifications: json returns the monthly time series in JSON format; csv returns the data as a CSV (comma separated value) file.
    ...
    return _make_api_request("DIGITAL_CURRENCY_MONTHLY", params, datatype)
